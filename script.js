...
const products = [
   ...
   { id: 43, name: "Toy car to build", category: "Electronics", price: 2500, original: 3000, badge: "new", rating: 5.0, reviews: 0, freeDelivery: true, img: "product_img/Toy car to build.png", details: { description: "105 pieces ", material: "Standard", style: "Modern", finish: "Matte Finish", occasion: "Casual", sizes: ["Standard"], highlights: [ "🚚 FREE delivery to Vavuniya", "💵 Cash on Delivery available", "🎁 Great for gifting" ] } }
